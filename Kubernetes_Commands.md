...
aws configure set aws\_access\_key\_id \*\*\*\*\*\*\*\*\*\*\*\*;

aws configure set aws\_secret\_access\_key \*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*;
...
* aws eks --region ap-southeast-1 update-kubeconfig --name K8\_Vinod
...
* aws eks --region ap-southeast-1 describe-cluster --name K8\_Vinod --query cluster.status
